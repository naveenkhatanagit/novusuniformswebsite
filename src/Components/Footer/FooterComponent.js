  ...
  return (
    ...
    <div className="middle">
      ...
      <ul className="copy text-center">
        ...
        <li><a href="#" className="select"><i className="fa fa-globe" aria-hidden="true"></i> Help</a></li>
        <li><a href="#" className="select"><i className="flag-icon-us"></i>Register As Seller</a></li>
      </ul>
    </div>
    ...
    <div className="bottom">
      <div className="center">
        ...
        <ul>
          ...
          <li><a href="#">IMDb<br/><span>Movies, TV<br/>&amp; Celebr/ties</span></a></li>
